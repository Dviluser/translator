    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'join_us':
                ...
                $sql = "INSERT INTO members (name, email, phone, gender, address)
...
<body>
                    ...
                    <div class="join-form-container slide-in">
                        <form id="joinForm" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="tel" class="form-control" id="joinPhone" name="phone" placeholder="9876543210" required maxlength="10" pattern="[0-9]{10}">
                                <div class="phone-validation" id="joinPhoneValidation">Enter a valid 10-digit mobile number</div>
                            </div>
                            <div class="mb-4">
                                <label for="joinAddress" class="form-label">
                                    <i class="fas fa-map-marker-alt"></i>
                                    <span>Address (Optional)</span>
                                </label>
                                <textarea class="form-control" id="joinAddress" name="address" rows="2" placeholder="Enter your full address (optional)"></textarea>
                            </div>
                            <div class="mb-4">
    ...
    <div class="modal fade" id="opinionModal" tabindex="-1" aria-labelledby="opinionModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="far fa-comment-dots me-2"></i><span></span></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
